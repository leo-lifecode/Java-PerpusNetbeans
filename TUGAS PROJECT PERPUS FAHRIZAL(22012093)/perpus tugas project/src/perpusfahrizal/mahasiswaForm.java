...
public class mahasiswaForm extends javax.swing.JDialog {
    ...
    public mahasiswaForm(java.awt.Frame parent, boolean modal) {
        ...
        if (mm.edit == true) {
            updateMahasiswa.setVisible(true);
            tambahMahasiswa.setVisible(false);
            txtnpm.setEditable(false);
            this.setTitle("Edit Data Mahasiswa");
        } else {
            updateMahasiswa.setVisible(false);
            tambahMahasiswa.setVisible(true);
            txtnpm.setEditable(true);
            this.setTitle("Tambah Data Mahasiswa");
        }
    }
...
//    }
    ...
    private void initComponents() {
        ...
        tambahMahasiswa.setBackground(new java.awt.Color(26, 34, 102));
        ...
        jPanel2.add(tambahMahasiswa, "card2");

        updateMahasiswa.setBackground(new java.awt.Color(87, 101, 116));
        updateMahasiswa.setForeground(new java.awt.Color(255, 255, 255));
        updateMahasiswa.setText("Update Data");
        updateMahasiswa.setBorderPainted(false);
        updateMahasiswa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateMahasiswaActionPerformed(evt);
            }
        });
        jPanel2.add(updateMahasiswa, "card3");
